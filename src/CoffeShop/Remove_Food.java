...
class Remove_Food implements ActionListener{
    JFrame f;
    JTextField t;
    ...
    Remove_Food(){
        ...
        l5.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("CoffeShop/icons/remove.jpg"));
        l5.setIcon(img);
        f.add(l5);

        
        l1=new JLabel("Food Id");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "select name,f_sold,f_left from allfoods where food_id ='"+t.getText()+"' ";
        ...
        if(ae.getSource()==b1){
            try{
                conn con = new conn();
                String str = "delete from allfoods where food_id = '"+t.getText()+"'";
